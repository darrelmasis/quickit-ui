...
export const buttonDoc = {
  ...
  examples: [{
    ...
    id: "ejemplos-estados",
    title: "Estados",
    description: "Incluye loading, spinner, loadingText, disabled y pressed.",
    preview: <div className="flex flex-wrap gap-3">
    ...
    note: "Nota: `pressEffect=\"ripple\"` requiere que el ripple esté habilitado en `QuickitProvider` o que lo actives por instancia con `ripple`."
  }, {
    id: "ejemplos-props",
    title: "Props",
