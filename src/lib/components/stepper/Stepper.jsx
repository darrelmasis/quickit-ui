            ...
            >
              ...
              >
                ...
                <div className={cn("min-w-0", !isVertical && "max-w-[10rem]")}>
                  <div className={cn("text-sm font-medium", current ? ui.titleCurrent : ui.title)}>{title}</div>
                  {description ? (
                    <p id={descId} className={cn("mt-0.5 text-xs", current ? ui.descriptionCurrent : ui.description)}>{description}</p>
                  ) : null}
                </div>
              </div>
            </li>
