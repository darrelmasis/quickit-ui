...
const LinkTextAppearance = forwardRef(function LinkTextAppearance(
  ...
  return (
    <a
      ...
      title={title}
      data-qk-ripple-hue={resolvedColor}
      className={cn(
        resolveQuickitFocusRingClasses(focusRingEnabled, LINK_BASE),
        resolvedRipple && "qk-ripple-host isolate overflow-hidden",
      ...
      style={{
        "--qk-ripple-color": rippleUi.color,
        "--qk-ripple-opacity": rippleUi.opacity,
        ...style,
      }}
...
const LinkButtonAppearance = forwardRef(function LinkButtonAppearance(
  ...
  return (
    <a
      ...
      rel={resolveExternalLinkRel(target, rel)}
      title={title}
      data-qk-ripple-hue={resolvedButtonColor}
      className={cn(
