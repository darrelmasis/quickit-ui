...
const BREADCRUMB_PRIMITIVES = {
  ...
  list: "flex flex-wrap items-center gap-1 sm:gap-1.5 break-words text-xs sm:text-sm",
  item: "flex items-center gap-1 sm:gap-1.5",
  ...
  itemContent: "inline-flex items-center gap-1 sm:gap-1.5",
};
