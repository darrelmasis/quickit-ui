export const ACTION_CONTROL_THEME_CLASSES = {
  light: {
    solid: {
      ...
      dark: "border-neutral-900 bg-neutral-900 text-white hover:border-black hover:bg-black focus-visible:outline-neutral-800",
    },
    outline: {
      neutral:
      ...
      dark: "border-neutral-300 bg-transparent text-neutral-900 hover:bg-neutral-100 hover:border-neutral-900 focus-visible:outline-neutral-800",
    },
    ghost: {
      neutral:
      ...
      dark: "border-transparent bg-transparent text-neutral-800 hover:bg-neutral-100 hover:text-neutral-950 focus-visible:outline-neutral-800",
    },
    soft: {
      neutral:
        "border-neutral-300 bg-neutral-100 text-neutral-700 hover:border-neutral-800 hover:bg-neutral-800 hover:text-white focus-visible:outline-neutral-500",
      primary:
        "border-sky-300 bg-sky-50 text-sky-700 hover:border-sky-600 hover:bg-sky-600 hover:text-white focus-visible:outline-sky-600",
      success:
        "border-emerald-300 bg-emerald-50 text-emerald-700 hover:border-emerald-600 hover:bg-emerald-600 hover:text-white focus-visible:outline-emerald-600",
      danger:
        "border-rose-300 bg-rose-50 text-rose-700 hover:border-rose-600 hover:bg-rose-600 hover:text-white focus-visible:outline-rose-600",
      warning:
        "border-amber-400 bg-amber-50 text-amber-800 hover:border-amber-400 hover:bg-amber-400 hover:text-neutral-950 focus-visible:outline-amber-500",
      info: "border-cyan-300 bg-cyan-50 text-cyan-700 hover:border-cyan-600 hover:bg-cyan-600 hover:text-white focus-visible:outline-cyan-600",
      light:
        "border-neutral-200 bg-neutral-50 text-neutral-600 hover:border-neutral-200 hover:bg-neutral-200 hover:text-neutral-900 focus-visible:outline-neutral-400",
      dark: "border-neutral-300 bg-neutral-100 text-neutral-800 hover:border-neutral-900 hover:bg-neutral-900 hover:text-white focus-visible:outline-neutral-800",
    },
  },
  dark: {
    solid: {
      ...
      dark: "border-neutral-800 bg-neutral-800 text-white hover:border-neutral-700 hover:bg-neutral-700 focus-visible:outline-neutral-500",
    },
    outline: {
      neutral:
      ...
      dark: "border-neutral-700 bg-transparent text-neutral-100 hover:bg-neutral-900 hover:border-neutral-600 focus-visible:outline-neutral-400",
    },
    ghost: {
      neutral:
      ...
      dark: "border-transparent bg-transparent text-neutral-300 hover:bg-neutral-900 hover:text-white focus-visible:outline-neutral-400",
    },
    soft: {
      neutral:
        "border-neutral-600 bg-neutral-800 text-neutral-300 hover:border-neutral-700 hover:bg-neutral-700 hover:text-white focus-visible:outline-neutral-500",
      primary:
        "border-sky-500/40 bg-sky-500/15 text-sky-300 hover:border-sky-500 hover:bg-sky-500 hover:text-neutral-950 focus-visible:outline-sky-300",
      success:
        "border-emerald-500/40 bg-emerald-500/15 text-emerald-300 hover:border-emerald-500 hover:bg-emerald-500 hover:text-neutral-950 focus-visible:outline-emerald-300",
      danger:
        "border-rose-500/40 bg-rose-500/15 text-rose-300 hover:border-rose-500 hover:bg-rose-500 hover:text-neutral-950 focus-visible:outline-rose-300",
      warning:
